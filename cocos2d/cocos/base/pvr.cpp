...
static void PVRDecompress(AMTC_BLOCK_STRUCT* pCompressedData, const bool Do2bitMode, const int XDim, const int YDim,
                          const int AssumeImageTiles, unsigned char* pResultImage);
 ...
 *************************************************************************/
int PVRTDecompressPVRTC(const void* const pCompressedData, const int XDim, const int YDim, void* pDestData,
                          ...
                          const int AssumeImageTiles, unsigned char* pResultImage)
{
    ...
    AMTC_BLOCK_STRUCT* pPrevious[2][2] = {
    {  NULL, NULL}
    , {NULL, NULL}
    };
