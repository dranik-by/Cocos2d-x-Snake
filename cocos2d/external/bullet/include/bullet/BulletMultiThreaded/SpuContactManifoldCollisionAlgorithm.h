...
public:
    ...
    SpuContactManifoldCollisionAlgorithm(const btCollisionAlgorithmConstructionInfo &ci, const btCollisionObject* body0,
    ...
    struct CreateFunc : public btCollisionAlgorithmCreateFunc
    {
                                                               ...
                                                               const btCollisionObjectWrapper* body1Wrap)
        {
            ...
            return new(mem) SpuContactManifoldCollisionAlgorithm(ci, body0Wrap->getCollisionObject(),
