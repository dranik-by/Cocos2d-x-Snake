...
public:
    ...
    {
        return btVector3(m_real_buf[0], m_real_buf[1], m_real_buf[2]);
    }   // in world frame
    ...
    //
    void stepVelocities(btScalar dt, btAlignedObjectArray<btScalar> &scratch_r,
    ...
    void calcAccelerationDeltas(const btScalar* force, btScalar* output, btAlignedObjectArray<btScalar> &scratch_r,
    ...
    void fillContactJacobian(int link, const btVector3 &contact_point, const btVector3 &normal, btScalar* jac,
                             btAlignedObjectArray<btScalar> &scratch_r, btAlignedObjectArray<btVector3> &scratch_v,
    ...
    void setNumLinks(
    int numLinks)//careful: when changing the number of links, make sure to re-initialize or update existing links
    {
