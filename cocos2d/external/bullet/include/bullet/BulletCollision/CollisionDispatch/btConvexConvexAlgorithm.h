...
public:
    ...
    btConvexConvexAlgorithm(btPersistentManifold* mf, const btCollisionAlgorithmConstructionInfo &ci,
    ...
    struct CreateFunc : public btCollisionAlgorithmCreateFunc
    {
                                                               ...
                                                               const btCollisionObjectWrapper* body1Wrap)
        {
            ...
            return new(mem) btConvexConvexAlgorithm(ci.m_manifold, ci, body0Wrap, body1Wrap, m_simplexSolver,
