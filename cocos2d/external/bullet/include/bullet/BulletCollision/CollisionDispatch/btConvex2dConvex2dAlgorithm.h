...
public:
    ...
    btConvex2dConvex2dAlgorithm(btPersistentManifold* mf, const btCollisionAlgorithmConstructionInfo &ci,
    ...
    struct CreateFunc : public btCollisionAlgorithmCreateFunc
    {
                                                               ...
                                                               const btCollisionObjectWrapper* body1Wrap)
        {
            ...
            return new(mem) btConvex2dConvex2dAlgorithm(ci.m_manifold, ci, body0Wrap, body1Wrap, m_simplexSolver,
                                                        m_pdSolver, m_numPerturbationIterations,
