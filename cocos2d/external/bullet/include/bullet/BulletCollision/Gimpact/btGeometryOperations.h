...
SIMD_FORCE_INLINE void bt_edge_plane(const btVector3 &e1, const btVector3 &e2, const btVector3 &normal,
                                     btVector4 &plane)
{
 ...
 */
SIMD_FORCE_INLINE void bt_closest_point_on_segment(btVector3 &cp, const btVector3 &v, const btVector3 &e1,
                                                   const btVector3 &e2)
{
    btVector3 n = e2 - e1;
    cp = v - e1;
...
SIMD_FORCE_INLINE int bt_line_plane_collision(const btVector4 &plane, const btVector3 &vDir, const btVector3 &vPoint,
                                              btVector3 &pout, btScalar &tparam, btScalar tmin, btScalar tmax)
{
...
SIMD_FORCE_INLINE void bt_segment_collision(const btVector3 &vA1, const btVector3 &vA2, const btVector3 &vB1,
