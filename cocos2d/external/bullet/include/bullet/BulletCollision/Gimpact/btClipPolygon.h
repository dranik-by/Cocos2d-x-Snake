...
SIMD_FORCE_INLINE void bt_plane_clip_polygon_collect(const btVector3 &point0, const btVector3 &point1, btScalar dist0,
...
*/
SIMD_FORCE_INLINE int bt_plane_clip_polygon(const btVector4 &plane, const btVector3* polygon_points,
                                            int polygon_point_count, btVector3* clipped)
{
    int clipped_count = 0;
    ...
    bt_plane_clip_polygon_collect(polygon_points[polygon_point_count - 1], polygon_points[0], olddist, firstdist,
...
*\return The count of the clipped counts
*/
SIMD_FORCE_INLINE int bt_plane_clip_triangle(const btVector4 &plane, const btVector3 &point0, const btVector3 &point1,
