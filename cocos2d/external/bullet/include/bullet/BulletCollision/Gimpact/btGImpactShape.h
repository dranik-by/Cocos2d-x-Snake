...
public:
    ...
    SIMD_FORCE_INLINE void setVertices(const btVector3 &v0, const btVector3 &v1, const btVector3 &v2,
                                       const btVector3 &v3)
    {
        m_vertices[0] = v0;
        m_vertices[1] = v1;
...
public:
    ...
    */
    virtual void processAllTriangles(btTriangleCallback* callback, const btVector3 &aabbMin,
    ...
    It gives the triangles in local space
    */
    virtual void processAllTrianglesRay(btTriangleCallback* /*callback*/, const btVector3 & /*rayFrom*/,
    ...
    */
    ...
    public:
        ...
        void lock()
        {
            ...
            m_meshInterface->getLockedReadOnlyVertexIndexBase(&vertexbase, numverts, type, stride, &indexbase,
                                                              indexstride, numfaces, indicestype, m_part);
        ...
        virtual void get_primitive_box(int prim_index, btAABB &primbox) const
        {
            ...
            primbox.calc_from_triangle_margin(triangle.m_vertices[0], triangle.m_vertices[1], triangle.m_vertices[2],
                                              triangle.m_margin);
        }
