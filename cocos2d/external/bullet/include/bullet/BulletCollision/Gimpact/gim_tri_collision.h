...
struct GIM_TRIANGLE_CONTACT_DATA
{
    ...
    SIMD_FORCE_INLINE void mergepoints_generic(const CLASS_PLANE &plane, GREAL margin, const btVector3* points,
    ...
    //! classify points that are closer
    SIMD_FORCE_INLINE void merge_points(const btVector4 &plane, GREAL margin, const btVector3* points,
                                        GUINT point_count)
    {
...
if 0.0<= u+v <=1.0 then they are inside of triangle
    ...
    */
    SIMD_FORCE_INLINE bool get_uv_parameters(const btVector3 &point, const btVector3 &tri_plane, GREAL &u,
                                             GREAL &v) const
    {
    ...
    */
    ...
    SIMD_FORCE_INLINE bool ray_collision(const btVector3 &vPoint, const btVector3 &vDir, btVector3 &pout,
    ...
    SIMD_FORCE_INLINE bool ray_collision_front_side(const btVector3 &vPoint, const btVector3 &vDir, btVector3 &pout,
                                                    btVector3 &triangle_normal, GREAL &tparam,
