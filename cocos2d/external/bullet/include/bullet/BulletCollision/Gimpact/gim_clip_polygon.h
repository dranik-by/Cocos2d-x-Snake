...
SIMD_FORCE_INLINE void PLANE_CLIP_POLYGON_COLLECT(const CLASS_POINT &point0, const CLASS_POINT &point1, GREAL dist0,
                                                  GREAL dist1, CLASS_POINT* clipped, GUINT &clipped_count)
{
...
*/
template <typename CLASS_POINT, typename CLASS_PLANE, typename DISTANCE_PLANE_FUNC> SIMD_FORCE_INLINE GUINT

PLANE_CLIP_POLYGON_GENERIC(const CLASS_PLANE &plane, const CLASS_POINT* polygon_points, GUINT polygon_point_count,
                           CLASS_POINT* clipped, DISTANCE_PLANE_FUNC distance_func)
{
    ...
    PLANE_CLIP_POLYGON_COLLECT(polygon_points[polygon_point_count - 1], polygon_points[0], olddist, firstdist, clipped,
                               clipped_count);
...
PLANE_CLIP_TRIANGLE_GENERIC(const CLASS_PLANE &plane, const CLASS_POINT &point0, const CLASS_POINT &point1,
                            const CLASS_POINT &point2, CLASS_POINT* clipped, DISTANCE_PLANE_FUNC distance_func)
{
    GUINT clipped_count = 0;
...
template <typename CLASS_POINT, typename CLASS_PLANE> SIMD_FORCE_INLINE GUINT

PLANE_CLIP_POLYGON3D(const CLASS_PLANE &plane, const CLASS_POINT* polygon_points, GUINT polygon_point_count,
                     CLASS_POINT* clipped)
{
...
PLANE_CLIP_TRIANGLE3D(const CLASS_PLANE &plane, const CLASS_POINT &point0, const CLASS_POINT &point1,
                      const CLASS_POINT &point2, CLASS_POINT* clipped)
{
