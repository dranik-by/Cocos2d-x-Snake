...
void gim_radix_sort_array_tokens(T* array, GIM_RSORT_TOKEN* sorted_tokens, GUINT element_count,
...
bool gim_binary_search_ex(const T* _array, GUINT _start_i, GUINT _end_i, GUINT &_result_index,
                          const KEYCLASS &_search_key, COMP_CLASS _comp_macro)
{
    GUINT _k;
    int _comp_result;
    GUINT _i = _start_i;
