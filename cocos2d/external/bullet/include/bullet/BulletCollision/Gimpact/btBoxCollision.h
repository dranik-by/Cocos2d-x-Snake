...
public:
    ...
    template <typename CLASS_POINT>
    SIMD_FORCE_INLINE void calc_from_triangle_margin(const CLASS_POINT &V1, const CLASS_POINT &V2,
    ...
    SIMD_FORCE_INLINE void appy_transform(const btTransform &trans)
    {
        ...
        btVector3 textends = extends.dot3(trans.getBasis().getRow(0).absolute(), trans.getBasis().getRow(1).absolute(),
    ...
    SIMD_FORCE_INLINE void appy_transform_trans_cache(const BT_BOX_BOX_TRANSFORM_CACHE &trans)
    {
        ...
        btVector3 textends = extends.dot3(trans.m_R1to0.getRow(0).absolute(), trans.m_R1to0.getRow(1).absolute(),
    ...
    */
    ...
    SIMD_FORCE_INLINE bool overlapping_trans_cache(const btAABB &box, const BT_BOX_BOX_TRANSFORM_CACHE &transcache,
                                                   bool fulltest) const
    {
    ...
    SIMD_FORCE_INLINE bool collide_triangle_exact(const btVector3 &p1, const btVector3 &p2, const btVector3 &p3,
