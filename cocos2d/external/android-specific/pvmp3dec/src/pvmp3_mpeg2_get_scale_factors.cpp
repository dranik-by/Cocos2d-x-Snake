...
void pvmp3_mpeg2_get_scale_factors(mp3ScaleFactors* scalefac, mp3SideInfo* si, int32 gr, int32 ch, mp3Header* info,
                                   uint32* scalefac_IIP_buffer, tmp3Bits* pMainData)
{
    ...
    pvmp3_mpeg2_get_scale_data(si, gr, ch, info, (uint32*)scalefac_buffer, (uint32*)scalefac_IIP_buffer, pMainData);
