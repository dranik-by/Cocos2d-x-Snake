...
uint32 getNbits(tmp3Bits* ptBitStream, int32 neededBits) /* number of bits to read from the bitstream (up to 25) */
{
    ...
    returnValue = (((uint32)(Elem)) << 24) | (((uint32)(Elem1)) << 16) | (((uint32)(Elem2)) << 8) | ((uint32)(Elem3));
...
uint16 getUpTo9bits(tmp3Bits* ptBitStream, int32 neededBits) /* number of bits to read from the bit stream 2 to 9 */
{
    ...
    returnValue = (((uint16)(Elem)) << 8) | ((uint16)(Elem1));
...
uint32 getUpTo17bits(tmp3Bits* ptBitStream, int32 neededBits) /* number of bits to read from the bit stream 2 to 8 */
{
    ...
    returnValue = (((uint32)(Elem)) << 16) | (((uint32)(Elem1)) << 8) | ((uint32)(Elem2));
